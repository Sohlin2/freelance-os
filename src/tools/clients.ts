...
export function registerClientTools(server: McpServer, userId: string): void {
  ...
  // Tool 3: clients.records.list
  server.registerTool(
    'clients.records.list',
    {
      description:
  ...
  // Tool 5: clients.records.archive
  server.registerTool(
