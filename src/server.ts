...
app.get('/.well-known/mcp/server-card.json', (_req, res) => {
  res.json({
    ...
    tools: [
      { name: 'create_client', description: 'Create a new client record', inputSchema: { type: 'object' } },
      { name: 'list_clients', description: 'List all clients', inputSchema: { type: 'object' } },
      { name: 'get_client', description: 'Get client details by ID', inputSchema: { type: 'object' } },
      { name: 'create_project', description: 'Create a new project for a client', inputSchema: { type: 'object' } },
      { name: 'list_projects', description: 'List projects, optionally filtered by client', inputSchema: { type: 'object' } },
      { name: 'get_project', description: 'Get project details by ID', inputSchema: { type: 'object' } },
      { name: 'update_project', description: 'Update project fields', inputSchema: { type: 'object' } },
      { name: 'create_proposal', description: 'Create a proposal for a project', inputSchema: { type: 'object' } },
      { name: 'list_proposals', description: 'List proposals, optionally filtered by project', inputSchema: { type: 'object' } },
      { name: 'get_proposal', description: 'Get proposal details by ID', inputSchema: { type: 'object' } },
      { name: 'update_proposal', description: 'Update proposal fields', inputSchema: { type: 'object' } },
      { name: 'create_invoice', description: 'Create an invoice for a project', inputSchema: { type: 'object' } },
      { name: 'list_invoices', description: 'List invoices, optionally filtered by project', inputSchema: { type: 'object' } },
      { name: 'get_invoice', description: 'Get invoice details by ID', inputSchema: { type: 'object' } },
      { name: 'update_invoice', description: 'Update invoice fields', inputSchema: { type: 'object' } },
      { name: 'create_time_entry', description: 'Log a time entry for a project', inputSchema: { type: 'object' } },
      { name: 'list_time_entries', description: 'List time entries, optionally filtered', inputSchema: { type: 'object' } },
      { name: 'aggregate_time', description: 'Aggregate time entries by project', inputSchema: { type: 'object' } },
      { name: 'create_scope_definition', description: 'Define scope boundaries for a project', inputSchema: { type: 'object' } },
      { name: 'list_scope_changes', description: 'List scope changes for a project', inputSchema: { type: 'object' } },
      { name: 'log_scope_change', description: 'Log a scope change request', inputSchema: { type: 'object' } },
      { name: 'create_follow_up', description: 'Create a follow-up reminder', inputSchema: { type: 'object' } },
      { name: 'list_follow_ups', description: 'List follow-ups, optionally filtered', inputSchema: { type: 'object' } },
      { name: 'get_follow_up', description: 'Get follow-up details by ID', inputSchema: { type: 'object' } },
      { name: 'mark_follow_up_sent', description: 'Mark a follow-up as sent', inputSchema: { type: 'object' } },
    ],
    resources: [],
    prompts: [],
  });
